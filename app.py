...
TEAMS_ELIMINATION = {
    ...
    "MAR": 3, "BEL": 3, "FRA": 99, "ESP": 99, "NOR": 99, "GBR": 99, "ARG": 99, "CHE": 99
}
...
MATCH_DETAILS = {
    "MAR": {"match": "FRA 2 x 0 MAR", "date": "09-07-2026"}, 
    "BEL": {"match": "ESP 2 x 1 BEL", "date": "10-07-2026"},
    "BRA": {"match": "NOR 2 x 1 BRA", "date": "05-07-2026"}, 
    "CAN": {"match": "MAR 3 x 0 CAN", "date": "04-07-2026"},
    "COL": {"match": "CHE 0 (4) x (3) 0 COL", "date": "07-07-2026"}, 
    "EGY": {"match": "ARG 3 x 2 EGY", "date": "07-07-2026"},
    "USA": {"match": "BEL 4 x 1 USA", "date": "06-07-2026"}, 
    "MEX": {"match": "GBR 3 x 2 MEX", "date": "05-07-2026"},
    "PRY": {"match": "FRA 1 x 0 PRY", "date": "04-07-2026"}, 
    "PRT": {"match": "ESP 1 x 0 PRT", "date": "06-07-2026"},
    "DZA": {"match": "CHE 2 x 0 DZA", "date": "02-07-2026"}, 
    "AUS": {"match": "EGY 1 (4) x (2) 1 AUS", "date": "03-07-2026"},
...
stage_index = st.sidebar.select_slider(
    "Select Stage:", 
...
for country_code, elimination_index in TEAMS_ELIMINATION.items():
    ...
    # Retrieve match details if eliminated
